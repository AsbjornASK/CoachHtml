...
export default async () => {
  ...
  return json({
    ...
    yesterdayWellness: {
      date:         yesterday,
      mood:         yw.mood         ?? null,
      soreness:     yw.soreness     ?? null,
      fatigue:      yw.fatigue      ?? null,
      motivation:   yw.motivation   ?? null,
      stress:       yw.stress       ?? null,
      sleepQuality: yw.sleepQuality ?? null,
      comments:     yw.comments     ?? null,
    },
    events: rawEvents,
    pairSuggestions,
  });
